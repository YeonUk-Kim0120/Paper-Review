...
논문 스터디와 세미나에서 발표한 자료들을 정리한 레포지토리입니다.
...
|                               3D Reconstruction                                |               Neural Radiance Fields (NeRF)                |                3D Gaussian Splatting (3DGS)                |
| :----------------------------------------------------------------------------: | :--------------------------------------------------------: | :--------------------------------------------------------: |
| <img src="./image/3D_Reconstruction.jpg" alt="3D Reconstruction" width="280"/> | <img src="./image/NeRF_image.png" alt="NeRF" width="280"/> | <img src="./image/3DGS_image.jpg" alt="3DGS" width="280"/> |
